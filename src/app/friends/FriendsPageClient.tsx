      ...
      {tabs.map((t) => (
        ...
        >
          ...
          {t.id === "requests" && requestCount > 0 && (
            <span className="ml-1.5 inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-red-500 px-1.5 text-xs leading-none font-bold text-white">
              {requestCount}
            </span>
          )}
        </button>
    ...
    <div className="space-y-6">
      <form onSubmit={handleSearch} className="flex gap-2">
        <input
          ...
          className="min-w-0 flex-1 rounded-xl border border-black/10 bg-[#fafafa] px-4 py-2.5 text-sm text-neutral-700 placeholder:text-neutral-400 focus:border-[#050522] focus:ring-1 focus:ring-[#050522] focus:outline-none"
        />
        <button
          type="submit"
